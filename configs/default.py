...
_C.VOICE2POSE.GENERATOR.NUM_GROUPS = 16
_C.VOICE2POSE.GENERATOR.LAMBDA_REG = 1.0
_C.VOICE2POSE.GENERATOR.LAMBDA_SEQ_DIFF = 1.0
_C.VOICE2POSE.GENERATOR.LAMBDA_CODE_SEQ_KL = 1.0
_C.VOICE2POSE.GENERATOR.LAMBDA_CLIP_KL = 0.1
_C.VOICE2POSE.GENERATOR.LOSS_REG = None
_C.VOICE2POSE.GENERATOR.MOUSE_ONLY = False
...
_C.VOICE2POSE.GENERATOR.CLIP_CODE.TEST_WITH_CODE_MAPPER = False
...
_C.VOICE2POSE.POSE_ENCODER.NAME = 'Poses_Encoder'
...
_C.VOICE2POSE.CODE_DISCRIMINATOR = CN()
_C.VOICE2POSE.CODE_DISCRIMINATOR.NAME = None
_C.VOICE2POSE.CODE_DISCRIMINATOR.LEAKY_RELU = False
_C.VOICE2POSE.CODE_DISCRIMINATOR.LAMBDA_GAN = 1.0
_C.VOICE2POSE.CODE_DISCRIMINATOR.SEQUENCE = False
...
_C.POSE2POSE.AUTOENCODER.NUM_GROUPS = 16
_C.POSE2POSE.AUTOENCODER.WITH_AUDIO = False
_C.POSE2POSE.AUTOENCODER.CODE_DUAL = False
_C.POSE2POSE.AUTOENCODER.CODE_DIM = 32
_C.POSE2POSE.LAMBDA_REG = 1.0
_C.POSE2POSE.LAMBDA_KL = 1.0
_C.POSE2POSE.LOSS_REG = None
_C.POSE2POSE.MOUSE_ONLY = False
